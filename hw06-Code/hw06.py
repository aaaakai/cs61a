...
class VendingMachine:
    ...
    'Here is your soda.'
    """
    def __init__(self, product, price, stock=0, funds=0):
    ...
    def add_funds(self, addition):
        if self.stock == 0:
            return 'Machine is out of stock. Here is your ${0}.'.format(addition)
        else:
            self.funds += addition
...
class Fib:
    ...
    def next(self):
        return Fib(self.value + self.pre_value, self.value)
